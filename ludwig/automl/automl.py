...
[
    ...
    "f1",
    "--ground_truth",
    "/tmp/tmpow02jfbv/2B0BDF3E74.csv",
    "--output_feature_name",
    "binary_56174",
    "--split_file",
    "/tmp/tmpow02jfbv/2B0BDF3E74.split.parquet",
    "--ground_truth_metadata",
    "/tmp/tmpow02jfbv/experiment_run/model/training_set_metadata.json",
    "--probabilities",
    "/tmp/tmpow02jfbv/experiment_run/predictions.parquet",
    "/tmp/tmpow02jfbv/experiment_run/predictions.parquet",
    "--model_names",
    "Model1",
    "Model2",
    "-od",
    "/tmp/tmpow02jfbv/experiment_run",
]
[
    "python",
    "-m",
    ...
    "f1",
    "--ground_truth",
    "/tmp/tmpkdlgrwgz/A62F9FCFB1.csv",
    "--output_feature_name",
    "category_31702",
    "--split_file",
    "/tmp/tmpkdlgrwgz/A62F9FCFB1.split.parquet",
    "--ground_truth_metadata",
    "/tmp/tmpkdlgrwgz/experiment_run/model/training_set_metadata.json",
    "--probabilities",
    "/tmp/tmpkdlgrwgz/experiment_run/predictions.parquet",
    "/tmp/tmpkdlgrwgz/experiment_run/predictions.parquet",
    "--model_names",
    "Model1",
    "Model2",
    "-od",
    "/tmp/tmpkdlgrwgz/experiment_run",
]
...
[
    ...
    "f1",
    "--ground_truth",
    "/tmp/tmpw3oczwlo/3CB5D9FE9A.csv",
    "--output_feature_name",
    "category_6E0A5",
    "--split_file",
    "/tmp/tmpw3oczwlo/3CB5D9FE9A.split.parquet",
    "--ground_truth_metadata",
    "/tmp/tmpw3oczwlo/experiment_run/model/training_set_metadata.json",
    "--probabilities",
    "/tmp/tmpw3oczwlo/experiment_run/predictions.parquet",
    "/tmp/tmpw3oczwlo/experiment_run/predictions.parquet",
    "--model_names",
    "Model1",
    "Model2",
    "-od",
    "/tmp/tmpw3oczwlo/experiment_run",
]
