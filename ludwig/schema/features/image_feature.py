...
@ludwig_dataclass
class ECDImageInputFeatureConfig(ImageInputFeatureConfig):
...
@DeveloperAPI
@llm_input_config_registry.register(IMAGE)
@ludwig_dataclass
class LLMImageInputFeatureConfig(ImageInputFeatureConfig):
    encoder: BaseEncoderConfig = EncoderDataclassField(
        MODEL_LLM,
        feature_type=IMAGE,
        default="stacked_cnn",
